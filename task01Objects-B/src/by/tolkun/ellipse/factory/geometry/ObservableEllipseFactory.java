...
/**
 * Class of factory for producing {@code ObservableEllipse}.
 *
 * @author Kirill Tolkun
 */
public class ObservableEllipseFactory extends Geometric2DFactory {

    /**
     * Logger for class {@code ObservableEllipseFactory}.
     */
    private static final Logger LOGGER
            = LogManager.getLogger(ObservableEllipseFactory.class);

    /**
     * Default constructor.
     */
    public ObservableEllipseFactory() {
        LOGGER.debug("ObservableEllipseFactory created.");
    }

    /**
     * Factory method for creating {@code ObservableEllipse}.
     *
     ...
     * @return geometric figure in a square ({@code ObservableEllipse})
    ...
    public Geometry2D createFigure(final double... coordinates)
        ...
        return new ObservableEllipse(beginPoint, endPoint);
    }
}
